...
1、在dara文件夹下创建对应数据集文件夹

2、运行如下命令进行预处理：

>python3 preprocess.py --data_root='../data/train_ko_0318/' --output='./dataset/kss/'

3、修改**hparams.py**中的**data_path**和**voc_model_id**

4、开始训练（-f参数训练1000w轮）：

>python train_wavernn.py -f
