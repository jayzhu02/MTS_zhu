...
if __name__ == "__main__":
    ...
    parser.add_argument('--voc_model_id', type=str, help='Directly point to dataset path and voc_model_id (overrides hparams.voc_model_id)')
    ...
    if args.voc_model_id is None:
        args.voc_model_id = hp.voc_model_id

    batch_size = hp.voc_batch_size
    
    # paths = Paths(hp.data_path, hp.voc_model_id)
    paths = Paths(args.data_root, args.voc_model_id)
    ...
    # restore_checkpoint(paths, voc_model, optimizer, scheduler, name=args.voc_model_id, create_if_missing=True)
