...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_directory", type=str, default="css10", help=".")
    parser.add_argument("--data_txt", type=str, default="css10.txt", help=".") 
    ...
    files_to_solve = [
        (args.data_directory, args.data_txt),         
        # (args.css10_directory, "train_ori.txt"),
        # (args.css10_directory, "val_ori.txt"),
        # (args.css_comvoi_directory, "train.txt"),
        # (args.css_comvoi_directory, "val.txt"),
    ]

    spectrogram_dirs = [
                        os.path.join(args.data_directory, '../spectrograms'), 
                        os.path.join(args.data_directory, '../linear_spectrograms'),
        ...
        with open(os.path.join(d, fs), 'w', encoding='utf-8') as f:
            for i in m:
                ...
                if splitted_a[0] == "..":
                    ...
                    # 让spectrograms和linear_spectrograms生成在data目录下
